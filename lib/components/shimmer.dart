...
///
enum _ShimmerDirection { ltr, rtl, ttb, btt }
...
/// * _ShimmerLayout effect only affects to opaque areas of [child], transparent areas
...
///
/// * use one [_ShimmerLayout] to wrap list of [Widget]s instead of a list of many [_ShimmerLayout]s
///
@immutable
class _ShimmerLayout extends StatefulWidget {
  final Widget child;
  ...
  /// [_ShimmerLayout] which [gradient] is [LinearGradient] made up of `baseColor` and
  /// `highlightColor`.
  ///
  _ShimmerLayout.fromColors({
    super.key,
    required this.child,
...
class _ShimmerState extends State<_ShimmerLayout> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(_ShimmerLayout oldWidget) {
    if (widget.enabled) {
      _controller.forward();
    } else {
      _controller.stop();
...
class _ShimmerFilter extends RenderProxyBox {
  ...
  set direction(_ShimmerDirection newDirection) {
